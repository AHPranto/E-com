...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_staff = models.BooleanField(
        ...
        default= False,
        help_text= gettext_lazy('Designates weather the user can log in this site')
    )
...
# To cheak all fields are compleates or not 
...
# this two function user model create and linekd with profile models
...
def save_profile(sender, instance, **kwargs):
    # related_name = 'profile' so..user model and profile model effect porbe
